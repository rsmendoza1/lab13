...
var resetForm = function () {
    ...
    if (header === msg) {
        ...
        html = html + "<tr><td>Phone:</td><td>" + email + "</td><tr>";
        html = html + "<tr><td>Country:</td><td>" + email + "</td><tr>";
        html = html + "<tr><td>Contact:</td><td>" + email + "</td><tr>";
        html = html + "<tr><td>Terms:</td><td>" + email + "</td><tr>";
